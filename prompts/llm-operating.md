...
**Use cautions and open questions as leading controls.** Before drafting external-facing content, read relevant `cautions`, `openQuestions`, `goals`, `aiInstructions`, reflections, and narrative variants for the target role, audience, organization, or achievement. Apply those constraints to the first draft. Do not treat cautions as after-the-fact cleanup.
