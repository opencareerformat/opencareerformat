...
**Keep public and targeted versions compatible.** When an existing LinkedIn profile or other public description is available, compare it with the targeted output. They do not need identical wording, detail, or emphasis, but they should fit together as broader and narrower views of the same underlying work. A targeted version may specialize a general public claim; it should not quietly repair or contradict it. If they conflict, return to the canonical facts and clarify the relationship before exporting.

**Apply the former-colleague test.** Before finalizing external claims, imagine the output being read by someone who understands the organization, the work, and its professional culture. A defensible version should leave them thinking, "I might describe it differently, but that is a fair account of what they did." Different terminology or vantage points are acceptable. If the wording implies authority, ownership, seniority, exclusivity, or scope the person did not have, narrow the title, statement, or attribution.
