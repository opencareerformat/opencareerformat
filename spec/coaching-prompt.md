...
- `spec/authoring-prompt.md`, which creates or updates career memory;
- `spec/curation-prompt.md`, which selects, questions, ranks, and improves content for a target or output;
- `spec/llm-prompt.md`, which gives general operating instructions for LLM-assisted OCF conversations.
