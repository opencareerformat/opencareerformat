...
Nothing yet. Open an issue or a discussion if you want to propose something.
...
- `spec/examples/sample-resume.json` — fictional but richly-built example demonstrating most spec features, including the conversational-mining pattern, the "stays in master, typically curated out" pattern, and populated AI-conversation fields.
