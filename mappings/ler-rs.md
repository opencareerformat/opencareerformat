...
OCF v0.1 does not define a canonical embedded verifiable credential payload. An LER-RS exporter may enrich OCF data with external wallet or badge evidence. That enrichment should be recorded in exporter provenance or extensions rather than silently changing the master OCF.
