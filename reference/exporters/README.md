...
```bash
node reference/exporters/json-resume.js spec/examples/sample-resume.json
node reference/exporters/json-resume.js spec/examples/sample-resume.json /tmp/sample-resume.resume.json
```
...
```bash
node reference/exporters/linkedin.js spec/examples/sample-resume.json
node reference/exporters/linkedin.js spec/examples/sample-resume.json /tmp/sample-linkedin.md
```
