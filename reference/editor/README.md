...
The TypeScript model is currently a partial mirror of the schema. It does not yet provide first-class editing UI for every v0.1 feature, including provenance, source artifacts, top-level organizations, competencies, narrative variants, title variants, reflections, goals, cautions, open questions, voice, and AI instructions.
