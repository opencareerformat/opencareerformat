...
function importedStarterContract() {
  return [
    ...
    'contacts must be an array of objects with kind and value. Valid kind values: email, phone, url, linkedin, github, social, other.',
    'locations must be an array like [{"city":"San Antonio","region":"TX","country":"US"}].',
    "Do not use person.email, person.phone, person.city, person.country, person.url, or string person.name.",
    "",
