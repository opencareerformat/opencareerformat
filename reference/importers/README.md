...
> Using this resume text and the schema at https://opencareerformat.org/v0.1/schema.json, please walk me through the OCF process to create my master OCF. Treat this resume as a source artifact, preserve useful audience-specific wording as narrative variants, and propose uncertain claims as open questions instead of inventing facts.
